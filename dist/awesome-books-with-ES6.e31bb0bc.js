...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"modules/bookClass.js":[function(require,module,exports) {
"use strict";
...
// Book class
var Book = /*#__PURE__*/_createClass(function Book(title, author) {
...
},{}],"modules/bookslistClass.js":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _bookClass = _interopRequireDefault(require("./bookClass.js"));
...
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); } // Import Book class
...
var emptyAuthor = document.getElementById('empty-author');
...
var BooksList = /*#__PURE__*/function () {
  ...
  _createClass(BooksList, [{
    key: "AddBook",
    value: function AddBook(title, author) {
      if (title === '') {
        ...
        var newBook = new _bookClass.default(title, author);
    ...
    value: function ShowBooks() {
      ...
      this.books.forEach(function (book) {
        ...
        bookInfo.innerHTML = "<p><span class=\"book-title\">\"".concat(book.title, "\"</span> by <span class=\"book-author\"> ").concat(book.author, "</span></p>");
...
},{"./bookClass.js":"modules/bookClass.js"}],"node_modules/luxon/build/es6/luxon.js":[function(require,module,exports) {
"use strict";
...
var IANAZone = /*#__PURE__*/function (_Zone2) {
  ...
  _createClass(IANAZone, [{
    ...
    value: function offset(ts) {
      ...
      var _ref3 = dtf.formatToParts ? partsOffset(dtf, date) : hackyOffset(dtf, date),
  ...
  _createClass(PolyDateFormatter, [{
    ...
    value: function format() {
      if (this.originalZone) {
        ...
        return this.formatToParts().map(function (_ref5) {
      ...
      if (this.originalZone) {
        return parts.map(function (part) {
          if (part.type === "timeZoneName") {
            var offsetName = _this2.originalZone.offsetName(_this2.dt.ts, {
              locale: _this2.dt.locale,
              format: _this2.opts.timeZoneName
            });
  ...
  _createClass(Locale, [{
    ...
    value: function months(length) {
      ...
      return listStuff(this, length, defaultOK, _months, function () {
        ...
        if (!_this3.monthsCache[formatStr][length]) {
          _this3.monthsCache[formatStr][length] = mapMonths(function (dt) {
            return _this3.extract(dt, intl, "month");
          });
        }
        return _this3.monthsCache[formatStr][length];
      });
    }
  }, {
    key: "weekdays",
    value: function weekdays(length) {
      ...
      return listStuff(this, length, defaultOK, _weekdays, function () {
        var intl = format ? {
          ...
          formatStr = format ? "format" : "standalone";
        if (!_this4.weekdaysCache[formatStr][length]) {
          _this4.weekdaysCache[formatStr][length] = mapWeekdays(function (dt) {
            return _this4.extract(dt, intl, "weekday");
          });
        }
        return _this4.weekdaysCache[formatStr][length];
      });
    }
  }, {
    key: "meridiems",
    value: function meridiems() {
      ...
      return listStuff(this, undefined, defaultOK, function () {
        ...
        if (!_this5.meridiemCache) {
          var intl = {
            hour: "numeric",
            hourCycle: "h12"
          };
          _this5.meridiemCache = [DateTime.utc(2016, 11, 13, 9), DateTime.utc(2016, 11, 13, 19)].map(function (dt) {
            return _this5.extract(dt, intl, "dayperiod");
          });
        }
        return _this5.meridiemCache;
      });
    }
  }, {
    key: "eras",
    value: function eras(length) {
      ...
      return listStuff(this, length, defaultOK, _eras, function () {
        ...
        if (!_this6.eraCache[length]) {
          _this6.eraCache[length] = [DateTime.utc(-40, 1, 1), DateTime.utc(2017, 1, 1)].map(function (dt) {
            return _this6.extract(dt, intl, "era");
          });
        }
        return _this6.eraCache[length];
      });
    }
  }, {
    key: "extract",
    ...
    value: function formatDateTimeFromString(dt, fmt) {
      ...
      var knownEnglish = this.loc.listingMode() === "en",
        ...
        string = function string(opts, extract) {
          return _this9.loc.extract(dt, opts, extract);
        },
        ...
        maybeMacro = function maybeMacro(token) {
          ...
          if (formatOpts) {
            return _this9.formatWithSystemDefault(dt, formatOpts);
          } else {
            return token;
          }
        },
        ...
        tokenToString = function tokenToString(token) {
          ...
          switch (token) {
            // ms
            case "S":
              return _this9.num(dt.millisecond);
            case "u":
            // falls through
            case "SSS":
              return _this9.num(dt.millisecond, 3);
            // seconds
            case "s":
              return _this9.num(dt.second);
            case "ss":
              return _this9.num(dt.second, 2);
            // fractional seconds
            case "uu":
              return _this9.num(Math.floor(dt.millisecond / 10), 2);
            case "uuu":
              return _this9.num(Math.floor(dt.millisecond / 100));
            // minutes
            case "m":
              return _this9.num(dt.minute);
            case "mm":
              return _this9.num(dt.minute, 2);
            // hours
            case "h":
              return _this9.num(dt.hour % 12 === 0 ? 12 : dt.hour % 12);
            case "hh":
              return _this9.num(dt.hour % 12 === 0 ? 12 : dt.hour % 12, 2);
            case "H":
              return _this9.num(dt.hour);
            case "HH":
              return _this9.num(dt.hour, 2);
            // offset
            case "Z":
              // like +6
              return formatOffset({
                format: "narrow",
                allowZ: _this9.opts.allowZ
              });
            case "ZZ":
              // like +06:00
              return formatOffset({
            ...
            case "d":
              return useDateTimeFormatter ? string({
                day: "numeric"
              }, "day") : _this9.num(dt.day);
            case "dd":
              return useDateTimeFormatter ? string({
                day: "2-digit"
              }, "day") : _this9.num(dt.day, 2);
            // weekdays - standalone
            case "c":
              // like 1
              return _this9.num(dt.weekday);
            case "ccc":
              // like 'Tues'
            ...
            case "L":
              ...
              return useDateTimeFormatter ? string({
                month: "numeric",
                day: "numeric"
              }, "month") : _this9.num(dt.month);
            case "LL":
              // like 01, doesn't seem to work
              return useDateTimeFormatter ? string({
                month: "2-digit",
                day: "numeric"
              }, "month") : _this9.num(dt.month, 2);
            case "LLL":
              // like Jan
            ...
            case "y":
              ...
              return useDateTimeFormatter ? string({
                year: "numeric"
              }, "year") : _this9.num(dt.year);
            case "yy":
              // like 14
              return useDateTimeFormatter ? string({
                year: "2-digit"
              }, "year") : _this9.num(dt.year.toString().slice(-2), 2);
            case "yyyy":
              // like 0012
              return useDateTimeFormatter ? string({
                year: "numeric"
              }, "year") : _this9.num(dt.year, 4);
            case "yyyyyy":
              // like 000012
              return useDateTimeFormatter ? string({
                year: "numeric"
              }, "year") : _this9.num(dt.year, 6);
            // eras
            case "G":
              // like AD
              return era("short");
            ...
            case "GGGGG":
              return era("narrow");
            case "kk":
              return _this9.num(dt.weekYear.toString().slice(-2), 2);
            case "kkkk":
              return _this9.num(dt.weekYear, 4);
            case "W":
              return _this9.num(dt.weekNumber);
            case "WW":
              return _this9.num(dt.weekNumber, 2);
            case "o":
              return _this9.num(dt.ordinal);
            case "ooo":
              return _this9.num(dt.ordinal, 3);
            case "q":
              // like 1
              return _this9.num(dt.quarter);
            case "qq":
              // like 01
              return _this9.num(dt.quarter, 2);
            case "X":
              return _this9.num(Math.floor(dt.ts / 1000));
            case "x":
              return _this9.num(dt.ts);
            default:
      ...
      var tokenToField = function tokenToField(token) {
        ...
        tokenToString = function tokenToString(lildur) {
          return function (token) {
            ...
            if (mapped) {
              return _this10.num(lildur.get(mapped), token.length);
            } else {
              return token;
            }
          };
        ...
        realTokens = tokens.reduce(function (found, _ref7) {
          var literal = _ref7.literal,
            val = _ref7.val;
...
function combineExtractors() {
  ...
  return function (m) {
    return extractors.reduce(function (_ref8, ex) {
...
function removeZeroes(vals) {
  var newVals = {};
  for (var _i3 = 0, _Object$entries = Object.entries(vals); _i3 < _Object$entries.length; _i3++) {
  ...
  _createClass(Duration, [{
    ...
    value: function toHuman() {
      ...
      var l = orderedUnits$1.map(function (unit) {
        var val = _this11.values[unit];
        if (isUndefined(val)) {
          return null;
        }
        return _this11.loc.numberFormatter(_objectSpread(_objectSpread({
          style: "unit",
          unitDisplay: "long"
        }, opts), {}, {
          unit: unit.slice(0, -1)
    ...
    value: function plus(duration) {
      ...
      var dur = Duration.fromDurationLike(duration),
        result = {};
      for (var _i4 = 0, _orderedUnits$ = orderedUnits$1; _i4 < _orderedUnits$.length; _i4++) {
        var k = _orderedUnits$[_i4];
    ...
    value: function mapUnits(fn) {
      if (!this.isValid) return this;
      var result = {};
      for (var _i5 = 0, _Object$keys = Object.keys(this.values); _i5 < _Object$keys.length; _i5++) {
        var k = _Object$keys[_i5];
    ...
    value: function reconfigure() {
      var _ref10 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        ...
        numberingSystem = _ref10.numberingSystem,
        conversionAccuracy = _ref10.conversionAccuracy,
    ...
    value: function shiftTo() {
      ...
      var built = {},
        ...
        vals = this.toObject();
      var lastUnit;
      for (var _i6 = 0, _orderedUnits$2 = orderedUnits$1; _i6 < _orderedUnits$2.length; _i6++) {
        var k = _orderedUnits$2[_i6];
    ...
    value: function negate() {
      if (!this.isValid) return this;
      var negated = {};
      for (var _i7 = 0, _Object$keys2 = Object.keys(this.values); _i7 < _Object$keys2.length; _i7++) {
        var k = _Object$keys2[_i7];
    ...
    value: function equals(other) {
      ...
      for (var _i8 = 0, _orderedUnits$3 = orderedUnits$1; _i8 < _orderedUnits$3.length; _i8++) {
        var u = _orderedUnits$3[_i8];
  ...
  _createClass(Interval, [{
    ...
    value: function toFormat(dateFormat) {
      var _ref12 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
        _ref12$separator = _ref12.separator,
        separator = _ref12$separator === void 0 ? " – " : _ref12$separator;
      if (!this.isValid) return INVALID$1;
  ...
  _createClass(Info, null, [{
    ...
    value: function monthsFormat() {
      ...
      var _ref16 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
        ...
        outputCalendar = _ref16$outputCalendar === void 0 ? "gregory" : _ref16$outputCalendar;
    ...
    value: function weekdaysFormat() {
      ...
      var _ref18 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
        ...
        numberingSystem = _ref18$numberingSyste === void 0 ? null : _ref18$numberingSyste,
        _ref18$locObj = _ref18.locObj,
        locObj = _ref18$locObj === void 0 ? null : _ref18$locObj;
    ...
    value: function eras() {
      ...
      var _ref20 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
        ...
        locale = _ref20$locale === void 0 ? null : _ref20$locale;
...
function highOrderDiffs(cursor, later, units) {
  ...
  for (var _i9 = 0, _differs = differs; _i9 < _differs.length; _i9++) {
    var _differs$_i = _slicedToArray(_differs[_i9], 2),
      unit = _differs$_i[0],
...
function digitRegex(_ref21) {
  var numberingSystem = _ref21.numberingSystem;
...
function explainFromTokens(locale, input, format) {
  ...
  if (disqualifyingUnit) {
    ...
    var _buildRegex = buildRegex(units),
      ...
      matches = _match6[1],
      _ref32 = matches ? dateTimeFromMatches(matches) : [null, null, undefined],
      _ref33 = _slicedToArray(_ref32, 3),
      result = _ref33[0],
      zone = _ref33[1],
      specificOffset = _ref33[2];
...
function quickDT(obj, opts) {
  ...
  if (!isUndefined(obj.year)) {
    for (var _i10 = 0, _orderedUnits = orderedUnits; _i10 < _orderedUnits.length; _i10++) {
      var u = _orderedUnits[_i10];
...
var DateTime = /*#__PURE__*/function () {
  ...
  function DateTime(config) {
    ...
    if (!invalid) {
      ...
      if (unchanged) {
        var _ref34 = [config.old.c, config.old.o];
        c = _ref34[0];
        o = _ref34[1];
      } else {
  ...
  _createClass(DateTime, [{
    ...
    value: function setZone(zone) {
      var _ref35 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
        _ref35$keepLocalTime = _ref35.keepLocalTime,
        keepLocalTime = _ref35$keepLocalTime === void 0 ? false : _ref35$keepLocalTime,
        _ref35$keepCalendarTi = _ref35.keepCalendarTime,
        keepCalendarTime = _ref35$keepCalendarTi === void 0 ? false : _ref35$keepCalendarTi;
    ...
    value: function reconfigure() {
      var _ref36 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        ...
        numberingSystem = _ref36.numberingSystem,
        outputCalendar = _ref36.outputCalendar;
      var loc = this.loc.clone({
        locale: locale,
        numberingSystem: numberingSystem,
    ...
    value: function toISO() {
      var _ref37 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        ...
        _ref37$suppressSecond = _ref37.suppressSeconds,
        suppressSeconds = _ref37$suppressSecond === void 0 ? false : _ref37$suppressSecond,
        _ref37$suppressMillis = _ref37.suppressMilliseconds,
        suppressMilliseconds = _ref37$suppressMillis === void 0 ? false : _ref37$suppressMillis,
        _ref37$includeOffset = _ref37.includeOffset,
        includeOffset = _ref37$includeOffset === void 0 ? true : _ref37$includeOffset,
        _ref37$extendedZone = _ref37.extendedZone,
        extendedZone = _ref37$extendedZone === void 0 ? false : _ref37$extendedZone;
      if (!this.isValid) {
        return null;
      }
    ...
    value: function toISOTime() {
      var _ref39 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        ...
        suppressMilliseconds = _ref39$suppressMillis === void 0 ? false : _ref39$suppressMillis,
        _ref39$suppressSecond = _ref39.suppressSeconds,
        suppressSeconds = _ref39$suppressSecond === void 0 ? false : _ref39$suppressSecond,
        ...
        includePrefix = _ref39$includePrefix === void 0 ? false : _ref39$includePrefix,
        _ref39$extendedZone = _ref39.extendedZone,
        extendedZone = _ref39$extendedZone === void 0 ? false : _ref39$extendedZone,
        _ref39$format = _ref39.format,
        format = _ref39$format === void 0 ? "extended" : _ref39$format;
      if (!this.isValid) {
        return null;
      }
    ...
    value: function toSQLTime() {
      var _ref40 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        ...
        includeOffset = _ref40$includeOffset === void 0 ? true : _ref40$includeOffset,
        _ref40$includeZone = _ref40.includeZone,
        includeZone = _ref40$includeZone === void 0 ? false : _ref40$includeZone,
        _ref40$includeOffsetS = _ref40.includeOffsetSpace,
        includeOffsetSpace = _ref40$includeOffsetS === void 0 ? true : _ref40$includeOffsetS;
...
var _bookslistClass = _interopRequireDefault(require("./modules/bookslistClass.js"));
var _luxon = require("./node_modules/luxon/build/es6/luxon.js");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
...
var booksList = new _bookslistClass.default();
booksList.Magic();
document.querySelector('.date').innerHTML = _luxon.DateTime.now().toLocaleString(_luxon.DateTime.DATETIME_MED);

// Page content display by clicking on the corresponding navbar menu item
var navbarList = document.getElementById('navbar');
...
},{"./modules/bookslistClass.js":"modules/bookslistClass.js","./node_modules/luxon/build/es6/luxon.js":"node_modules/luxon/build/es6/luxon.js"}],"../../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/awesome-books-with-ES6.e31bb0bc.js.map